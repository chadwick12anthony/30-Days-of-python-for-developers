# 30-Days-of-python-for-developers
30 Days of python for developers , is what to know to start a career as a programmer and a developer.

## learn quick 
For the next 30 Days, learn the fundamentals of Python. We created this series as an introduction to programming with Python.

## from 30 Days of Python - Day 1 - Install Python 3.8 - Python TUTORIAL by CodingEntrepreneurs
